...
#import "GKNote+ImageURLFixes.h"
#import <objc/runtime.h>

@implementation GKNote (ImageURLFixes)

+ (void)load
{
    Method m1 = class_getInstanceMethod(self, @selector(setEntityChiefImage:));
...
- (void)setOriginImageURL:(NSURL *)originImageURL
{
    ...
    NSString *urlString = self.entityChiefImage.absoluteString;
