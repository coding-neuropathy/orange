...
- (void)setEntity:(GKEntity *)entity
{
    ...
    [self.tipLabel setText:[NSString stringWithFormat:@"%@ %ld  %@ %ld",[NSString fontAwesomeIconStringForEnum:FAHeart], (long)_entity.likeCount, [NSString fontAwesomeIconStringForEnum:FAComment], (long)_entity.noteCount]];
