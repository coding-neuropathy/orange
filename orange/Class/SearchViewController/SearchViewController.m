...
{
    _text = text;
    self.title = [NSString stringWithFormat:@"#%@",text];
}
...
{
    if (self.index == 0) {
        [GKAPI searchEntityWithString:self.text type:@"all" offset:0 count:30 success:^(NSDictionary *stat, NSArray *entityArray) {
