...
//    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.Guoku.Collin.CollinCoreData" in the application's documents directory.
...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CollinCoreData" withExtension:@"momd"];
...
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CollinCoreData.sqlite"];
//    NSError *error = nil;
